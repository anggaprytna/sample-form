...
export class PreAssessmentQuestions extends React.Component {
  ...
  addButton() {
    return (
      <Button block style={{borderRadius: 5, height: 50, backgroundColor: colors.gray5}} onPress={() => {this.props.navigation.navigate('notes_remarks_add')}}>
            ...
            <View style={{marginTop: 20}}>
              <View style={{borderWidth: 1, borderRadius: 5, borderColor: colors.gray2}}>
                <View style={{marginHorizontal: 10, marginTop: 5, justifyContent: 'center', alignContent: 'center'}}>
                  <Text type={'semibold'}>Notes satu</Text>
                  <View style={{flexDirection: "row", marginTop: 5}}>
                    <Icon name="user" color={colors.gray1} size={22} />
                    <Text type={'regular'}>{' '}</Text>
                    <Text type={'regular'}>Angga Priyatna</Text>
                  </View>
                  <View style={{flexDirection: "row", marginTop: 5}}>
                ...
                <View style={{flexDirection: "row", marginHorizontal: 10, marginBottom: 10, marginTop: 5}}>
                  ...
                  <TouchableHighlight style={{flex:1}} underlayColor={'transparent'} onPress={() => {this.props.navigation.navigate('notes_remarks_edit')}}>
