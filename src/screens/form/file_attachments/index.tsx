...
export class PreAssessmentQuestions extends React.Component {
        ...
        <Modal
          ...
          <View style={{marginHorizontal: 0}}>
            <View style={styles.containerModal}>
              <Text type={'semibold'} size={16}>Delete Attachment</Text>
              <Text type={'regular'} size={16} style={{textAlign: 'center'}}>Are you sure wanna delete this Attachment?</Text>
  ...
  nextButton() {
    return (
      <Button disabled={this.state.buttonDisabled} block onPress={this._handleSubmit} style={[{borderRadius: 5, height: 50}, {backgroundColor: (this.state.buttonDisabled ? colors.gray1 : colors.primary2)}]}>
        <Text type={'semibold'} size={17} style={{color: (this.state.buttonDisabled ? '#5a5a5a' : '#fff')}}>Submit</Text>
    </Button>
    );
  }
  ...
  addButton() {
    return (
      <Button block style={{borderRadius: 5, height: 50, backgroundColor: colors.gray5}} onPress={() => {this.props.navigation.navigate('file_attachments_add')}}>
        <Text type={'semibold'} size={17} style={{color: colors.primary2}}>Add Attachment</Text>
      </Button>
    );
  }
          ...
          <ScrollView style={{marginHorizontal: 16}} showsVerticalScrollIndicator={false}>
            ...
            <View style={{marginTop: 20}}>
              <View style={{borderWidth: 1, borderRadius: 5, borderColor: colors.gray2}}>
                <View style={{marginHorizontal: 10, marginTop: 5, justifyContent: 'center', alignContent: 'center'}}>
                  <View style={{flexDirection: "row", marginTop: 5}}>
                    <Icon name="file-text" color={colors.gray1} size={22} />
                    <Text type={'regular'}>{' '}</Text>
                    <Text type={'semibold'}>Angga Priyatna - CV.pdf</Text>
                  </View>
                  <View style={{flexDirection: "row", marginTop: 5}}>
                    <Icon name="calendar" color={colors.gray1} size={22} />
                    <Text type={'regular'}>{' '}</Text>
                    <Text type={'regular'}>2020-07-12</Text>
                  </View>
                </View>
                <View style={{flexDirection: "row", marginHorizontal: 10, marginBottom: 10, marginTop: 5}}>
                  ...
                  <TouchableHighlight style={{flex:1}} underlayColor={'transparent'} onPress={() => {this.props.navigation.navigate('file_attachments_edit')}}>
