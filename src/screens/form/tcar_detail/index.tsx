...
export class PreAssessmentQuestions extends React.Component {
  ...
  addButton() {
    return (
      <Button block style={{borderRadius: 5, height: 50, backgroundColor: colors.gray5}} onPress={() => {this.props.navigation.navigate('tcar_detail_add')}}>
        ...
        <View style={styles.SafeAreaView}>
          ...
          <ScrollView style={{marginHorizontal: 16}} showsVerticalScrollIndicator={false}>
            ...
            <View style={{flexDirection: 'row', marginTop: 5}}>
              <View style={{height: 50, borderColor: colors.gray2, borderWidth: 1, borderRadius: 5, flex: 1, marginRight: 5, justifyContent: 'center'}}>
                <Text type={'regular'} size={16} style={{textAlign: 'center'}}>Domestic</Text>
              </View>
              <View style={{height: 50, borderColor: colors.gray2, borderWidth: 1, borderRadius: 5, flex: 1, marginLeft: 5, justifyContent: 'center'}}>
                <Text type={'regular'} size={16} style={{textAlign: 'center'}}>Overseas</Text>
              </View>
            </View>
            ...
            <View style={{marginTop: 20}}>
              <View style={{borderWidth: 1, borderRadius: 5, borderColor: colors.gray2}}>
                <View style={{marginHorizontal: 10, marginTop: 5}}>
                  <Text type={'semibold'}>IT Workshop</Text>
                  <View style={{flexDirection: "row"}}>
                    <Text type={'regular'}>Air</Text>
                    <Text type={'regular'}>{' • '}</Text>
                    <Text type={'regular'}>Balikpapan - Jakarta</Text>
                  </View>
                  <Text type={'regular'}>2020-07-10</Text>
                </View>
